...
const FamilyListPage = () => {
  ...
  const startIndex = filteredMembers.length === 0 ? 0 : (currentPage - 1) * ITEMS_PER_PAGE + 1;
    ...
    <div className="min-h-screen bg-gradient-to-br from-orange-50 via-amber-50 to-white/90">
      ...
      <div className="mb-4 flex justify-between items-center">
        <p className="text-gray-600">
          Showing {filteredMembers.length === 0 ? 0 : `${startIndex}-${endIndex}`} of {filteredMembers.length} members
        </p>
